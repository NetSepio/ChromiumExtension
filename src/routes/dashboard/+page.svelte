...
<div class="p-5 mb-5 pb-5">
	...
	<div class="flex">
		<div class="flex-1 w-72">
			<div class="justify-center">
				<div class="block rounded-lg shadow-lg shadow-gray-500/50 p-5 w-auto h-auto content-around">
					<h1 class="font-bold text-lg">{currentUrl}</h1>
				</div>
			</div>
		</div>
		<div class="flex-none">
			<div class="flex justify-center">
				<div class="block rounded-lg shadow-lg shadow-gray-500/50 p-5 w-auto h-auto content-around">
					<div class="w-6 h-auto">
						...
						-------->
						<p class="font-bold text-lg">0/5</p>
					</div>
				</div>
			</div>
		</div>
	...
	<br />
	<div class="justify-center">
		<div class="block rounded-lg shadow-lg shadow-gray-500/50 p-5 w-auto h-auto">
			<h1 class="font-bold text-3xl text-center">{response.siteSafety}</h1>
			<Chart {data} type="donut" />
		</div>
	</div>
	<br />
	<div class="w-auto shadow-xl shadow-gray-500/50 bg-white dark:bg-gray-900 rounded-lg">
		<div class="card-body">
